...
#   skopeo inspect docker://mcr.microsoft.com/oss/go/microsoft/golang:1.26.4-azurelinux3.0 --format "{{.Name}}@{{.Digest}}"
DEFAULT_IMAGE="mcr.microsoft.com/oss/go/microsoft/golang@sha256:d5796c17060c98de4c9e719877ef72d784f2c877c403f80ff43ecdc6e01cb1ba"
...
resolve_go_image() {
  if [[ "${name:-}" == "npm" ]]; then
    ...
    # e.g. FROM mcr.../golang:1.26.4-azurelinux3.0 AS builder
    # e.g. FROM --platform=linux/amd64 mcr.../golang:1.26.4-azurelinux3.0 AS builder
